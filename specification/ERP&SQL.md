...
| class_no |  || `1 / 2 / 3 / 4 / 5 / 6 / 7 / 8 / 9`, ###3参照 |
...
|---|---|---|
| id | PK | 主キー |
| master_id | FK -> master.master_id, UNIQUE | 対応品目 |
| inspection_sheet_path |  | クラス9専用検査書ファイルのフルパス |
| created_at |  | 作成日時 |
| updated_at |  | 更新日時 |
